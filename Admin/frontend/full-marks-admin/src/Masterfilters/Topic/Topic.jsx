  ...
  const handleDelete = async (class_id) => {
    try {
      ...
      if (data.success) {
        ...
        fetchTopics(); // Refresh the classes list
      } else {
        ...
        <div className="row">
          ...
          <div className="col-md-10">
            <div className="container mt-3 bg-white shadow-lg p-3 mb-5 bg-white rounded">
              {/* Topbar */}
              <h5 className='text-grey my-3'>Topics</h5>
              <div className="row">
                <div className="col-md-6">
                  <Link to={'/addtopics'}><button className="btn btn-primary">Add Topics</button></Link>
                </div>
              </div>
              <hr></hr>
              {/* Table */}
